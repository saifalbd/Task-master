<template>
  <div class="asside-box">
    ...
    <div class="ul-title">administrative</div>
    <div class="side-bar-ul">
      <router-link
        class="ul-link"
        v-for="item in collapses"
        :to="item.to"
        :key="item.to"
      >
    ...
    <div class="ul-title">My Jobs</div>
    <div class="side-bar-ul">
      <router-link
        class="ul-link"
